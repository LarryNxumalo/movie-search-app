      ...
      <div class="md:flex p-6">
        ...
        <div class="md:w-2/3 md:pl-8 mt-6 md:mt-0">
          ...
          <div class="flex flex-wrap gap-4 mb-6">
            <span class="px-4 py-2 bg-gray-100 dark:bg-gray-700 rounded-full text-sm">
              {{ media.Year }}
            </span>
            <span class="px-4 py-2 bg-gray-100 dark:bg-gray-700 rounded-full text-sm">
              {{ media.Rated }}
          ...
          <div class="mb-6">
            ...
            <p class="text-gray-600 leading-relaxed">{{ media.Plot }}</p>
          </div>
            ...
            <div>
              ...
              <dl class="space-y-2">
                <div>
                  ...
                  <dd class="text-gray-600">{{ media.Genre }}</dd>
                </div>
                <div>
                  <dt class="font-medium">Director</dt>
                  <dd class="text-gray-600">{{ media.Director }}</dd>
                </div>
                <div>
                  <dt class="font-medium">Writers</dt>
                  <dd class="text-gray-600">{{ media.Writer }}</dd>
                </div>
                <div>
                  <dt class="font-medium">Actors</dt>
                  <dd class="text-gray-600">{{ media.Actors }}</dd>
                </div>
                <div>
                  <dt class="font-medium">Language</dt>
                  <dd class="text-gray-600">{{ media.Language }}</dd>
                </div>
                <div>
                  <dt class="font-medium">Country</dt>
                  <dd class="text-gray-600">{{ media.Country }}</dd>
                </div>
              </dl>
            </div>
            ...
            <div v-if="media.Ratings?.length">
              ...
              <div class="space-y-4">
                <div v-for="rating in media.Ratings" :key="rating.Source" 
                  ...
                  <div class="font-medium">{{ rating.Source }}</div>
                  <div class="text-gray-600">{{ rating.Value }}</div>
                </div>
              </div>
            </div>
          </div>
