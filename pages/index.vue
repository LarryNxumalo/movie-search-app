<template>
  <div>
    ...
    <section class="mb-12">
      ...
      <div v-else-if="featuredSeries.length" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
        <div v-for="show in featuredSeries" :key="show.imdbID" 
          class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
    ...
    <section v-if="recentlyViewed.length" class="mb-12">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
        <div v-for="item in recentlyViewed" :key="item.imdbID" 
          class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
